        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h6 class="section-title text-start text-primary text-uppercase">Sarokszoba</h6>
                        <h1 class="mb-4">Üdvözöljük a <span class="text-primary text-uppercase">HappyHotel</span> sarokszobájában!</h1>
                        <p class="mb-4">
                       <p> Engedje meg, hogy bemutassuk ezt a varázslatos és kényelmes szállásegységet, amely tökéletes választás családok számára, akik pihentető és emlékezetes időtöltésre vágynak.
                        A családi szoba tágas és elegáns kialakítással rendelkezik, hogy minden családtag kényelmesen elférjen. A szoba kellemes környezetet                        teremt a pihenéshez és a közös időtöltéshez, miközben a gyönyörű virágok látványa az ablakból garantáltan feledhetetlen élményt nyújt.
                        Az ablakokon át beszűrődő természetes fény és a virágok látványa azonnal felüdíti a szobát, és kellemes atmoszférát teremt a                        tartózkodás során. A szoba kényelmes ággyal vagy ágyakkal rendelkezik, amelyek garantálják a jó pihenést és a revitalizáló alvást                   minden családtag számára
                        A szoba modern berendezése és praktikus elrendezése lehetővé teszi a kényelmes és funkcionalitást, miközben a családtagok élvezhetik a                      közös időtöltést. Az íróasztal és a kényelmes ülőhelyek lehetőséget kínálnak a relaxációra vagy az együtt töltött időre, míg a szobához                     tartozó fürdőszoba a szükséges kényelmet és felszereltséget biztosítja mindenki számára.
                        A családi szoba ideális választás családok számára, akik együtt szeretnének pihenni és élvezni a közös időtöltést. Fedezze fel a [Hotel                         neve] családi szobáját, és hagyja, hogy a virágok látványa és a kényelem egyaránt lenyűgözze Önt és szeretteit!</p>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-10 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="../img/sarokszoba.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-4 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="../img/sarokszobabathroom.jpg">
                            </div>
