        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h6 class="section-title text-start text-primary text-uppercase">HoneyMoon lakosztály</h6>
                        <h1 class="mb-4">Üdvözöljük a <span class="text-primary text-uppercase">HappyHotel</span> Honeymoon lakosztályában!</h1>
                        <p class="mb-4">
                       <p> 
                        Üdvözöljük a HappyHotel Honeymoon Lakosztályában! Ez a szoba a romantika és a kényelem oázisa, ideális hely a friss házasoknak, hogy együtt élvezzék az első, felejthetetlen napokat az esküvőjük után. A lakosztály kifinomult és elegáns atmoszférával fogadja a                       vendégeket, melyet a romantikus megvilágítás, a puha textíliák és a stílusos berendezés tesz teljessé.

                        A Honeymoon Lakosztály luxusát nem csak a szoba kialakítása, hanem a kényelmi szolgáltatások is alátámasztják. A tágas franciaágy kényelmes matracán pihenve a vendégek elmerülhetnek a romantika világában, míg a szoba személyre szabott részletei még emlékezetesebbé teszik az itt töltött időt.

                        A Honeymoon Lakosztályhoz exkluzív kényelmi szolgáltatások is tartoznak, mint például pezsgőfürdő, privát szobaszerviz és kényelmes fürdőköpenyek, hogy minden pillanatot még kellemesebbé tegyenek a friss házasok számára.

                        A HappyHotel Honeymoon Lakosztálya tökéletes választás azoknak, akik romantikus és emlékezetes esküvői nászútra vágynak, ahol minden részlet gondosan megtervezett, hogy a vendégek a legtöbbet hozhassák ki az együtt töltött időből és az egymásra figyelő pillanatokból.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="../img/honeymoon.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="../img/honeybath.jpg">
                            </div>
                        </div>
                    </div>
                </div>
